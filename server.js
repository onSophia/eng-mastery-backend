...
const categories = [
    ...
    { id: 'basics', name: 'База', icon: '🧱', description: 'Самые важные слова для старта: местоимения, предлоги, артикли и основные глаголы' },
    { id: 'irregular_verbs', name: 'Неправильные глаголы', icon: '🔄', description: 'Самые важные английские неправильные глаголы в трех формах' },
    ...
    { id: 'dentist', name: 'Стоматология', icon: '🦷', description: 'Лечение зубов, протезирование, гигиена' }
];
